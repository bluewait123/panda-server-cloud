package com.panda.server.cloud.common.web.mybatis.config;
...
@MapperScan(basePackages = "com.panda.server.cloud.mybatis.mapper", sqlSessionFactoryRef = "druidSqlSessionFactory")
@Primary
